...
## Installation
**To install from releases (Recommended)**: Go to the releases tab and select the latest version. Then, download the file marked as Xaver_{version} and extract it to the directory you want to use it from. Then, launch the program and follow the instructions to set up the target folders and begin using the tool.
